...
---@class FAnimNode_AdvancedIK_GSC : FAnimNode_SkeletalControlBase
---@field IKParam FAdvancedIKMediator
...
local FAnimNode_AdvancedIK_GSC = {}
...
---@class FAnimNode_BlendListByPointer_GSC : FAnimNode_BlendListBase
local FAnimNode_BlendListByPointer_GSC = {}
...
---@field bTriggerNotifies boolean
...
---@class FAnimNode_CameraCopyBone_GSC : FAnimNode_SkeletalControlBase
---@field SourceBone FBoneReference
---@field TargetBone FBoneReference
---@field SocketRotation FRotator
---@field BoneShift FVector
---@field BoneRotate FRotator
---@field bCopyTranslation boolean
---@field bCopyRotation boolean
---@field bCopyScale boolean
---@field ControlSpace EBoneControlSpace
local FAnimNode_CameraCopyBone_GSC = {}
...
---@class FAnimNode_CopyAnotherSkeletonBone_GSC : FAnimNode_SkeletalControlBase
---@field SourceBone FName
---@field TargetBone FBoneReference
---@field bCopyTranslation boolean
---@field bCopyRotation boolean
---@field bCopyScale boolean
---@field ControlSpace EBoneControlSpace
---@field AnotherSkeletalMeshComponent USkeletalMeshComponent
local FAnimNode_CopyAnotherSkeletonBone_GSC = {}
...
---@class FAnimNode_CurveBlend_GSC : FAnimNode_Base
---@field SourcePose FPoseLink
---@field A FPoseLink
---@field B FPoseLink
---@field CurveArray TArray<FName>
---@field AlphaInputType EAnimAlphaInputType
---@field bAlphaBoolEnabled boolean
...
---@field AlphaCurveName FName
---@field AlphaScaleBiasClamp FInputScaleBiasClamp
local FAnimNode_CurveBlend_GSC = {}
...
---@class FAnimNode_DisableRootMotionGSC : FAnimNode_Base
---@field BasePose FPoseLink
---@field Alpha float
local FAnimNode_DisableRootMotionGSC = {}
...
---@field Settings ULegIKNodeSettingsAsset
...
---@field EntriesProvider URandomPlayerNodeEntriesProviderAsset
---@field Entries TArray<FRandomPlayerSequenceEntry>
---@field BlendWeight float
---@field bShuffleMode boolean
---@field bCustomBlending boolean
---@field bHasForcedInitialAnimation boolean
---@field ForcedInitialAnimationIndex int32
...
---@field StartPosition float
---@field bNormilizedExplicitTime boolean
...
---@class FAnimNode_SmoothCopyBone_GSC : FAnimNode_SkeletalControlBase
---@field SourceBone FBoneReference
---@field TargetBone FBoneReference
---@field WeaponTotalRotation FRotator
---@field WeaponTotalShift FVector
---@field WeaponSocketShift FVector
---@field WeaponSkeletalMeshComponent USkeletalMeshComponent
---@field DirectionWeaponSocketName FName
---@field ExtraRotator FRotator
---@field ControlSpace EBoneControlSpace
local FAnimNode_SmoothCopyBone_GSC = {}
...
---@class FAnimNode_TwoBoneIK_GSC : FAnimNode_SkeletalControlBase
---@field IKBone FBoneReference
---@field StartStretchRatio float
---@field MaxStretchScale float
---@field WeaponSkeletalMeshComponent USkeletalMeshComponent
---@field EffectorWeaponSocketName FName
---@field JointBone FBoneReference
---@field JointBoneOffset FVector
---@field WeaponBone FBoneReference
---@field ExtraRotator FRotator
---@field bUseSocketRotation boolean
---@field TwistAxis FAxis
---@field bAllowStretching boolean
---@field bAllowTwist boolean
local FAnimNode_TwoBoneIK_GSC = {}



---@class FAnimNode_TwoBoneShiftIK_GSC : FAnimNode_SkeletalControlBase
---@field IKBone FBoneReference
---@field StartStretchRatio float
---@field MaxStretchScale float
---@field EffectorOffset FVector
---@field JointOffset FVector
---@field TwistAxis FAxis
---@field bAllowStretching boolean
---@field bAllowTwist boolean
local FAnimNode_TwoBoneShiftIK_GSC = {}



---@class FAnimNode_TwoBoneSimpleIK_GSC : FAnimNode_SkeletalControlBase
---@field IKBone FBoneReference
---@field StartStretchRatio float
---@field MaxStretchScale float
---@field IKBoneTarget FBoneReference
---@field JointBoneTarget FBoneReference
---@field bSaveOriginalRotation boolean
---@field TwistAxis FAxis
---@field bAllowStretching boolean
---@field bAllowTwist boolean
local FAnimNode_TwoBoneSimpleIK_GSC = {}
...
---@class ULegIKNodeSettingsAsset : UDataAsset
---@field LegsDefinition TArray<FAnimLegIKDefinition>
local ULegIKNodeSettingsAsset = {}
...
---@class URandomPlayerNodeEntriesProviderAsset : UDataAsset
---@field RandomSequenceEntries TArray<FRandomPlayerSequenceEntry>
local URandomPlayerNodeEntriesProviderAsset = {}
