...
---@return FString
function ANiagaraActor:GetAssetPathNameOrSetChangedHandler() end
...
---@field bScaleSpawnCountByDistanceCurve boolean
---@field SpawnCountScaleCurve FNiagaraLinearRamp
...
---@class FNiagaraSystemTickLOD
---@field TickBehaviour EFTickBehaviour
---@field ScreenSize float
---@field TicksCountToSkip int32
---@field TickDeltaScale float
---@field bUseMotionVectors boolean
local FNiagaraSystemTickLOD = {}



---@class FNiagaraSystemTickLODArray
---@field LODs TArray<FNiagaraSystemTickLOD>
local FNiagaraSystemTickLODArray = {}
...
---@field TickLODsInsideViewFrustum FNiagaraSystemTickLODArray
---@field TickLODsOutsideViewFrustum FNiagaraSystemTickLODArray
