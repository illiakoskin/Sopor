...
---@class IGSCSkeletalAnimationSectionSelectable : IInterface
local IGSCSkeletalAnimationSectionSelectable = {}
...
---@class IMovieSceneSectionTemplateDecorator : IInterface
local IMovieSceneSectionTemplateDecorator = {}
...
---@field CharacterNameSID FString
---@field TextSID FString
...
---@field SyncActor TSoftObjectPtr<AActor>
---@field SyncLocation FVector
---@field SyncRotation FRotator
---@field DynamicSyncActor TSoftObjectPtr<AActor>
---@field DynamicSyncGuid FGuid
---@field OverrideRotation FRotator
---@field BlendFramesNum int32
---@field BlendExpForEaseInOut float
---@field bUsedForPreblend boolean
---@field bUsingAnimBudgeting boolean
...
---@field bGSCIgnoreRootMotion boolean
