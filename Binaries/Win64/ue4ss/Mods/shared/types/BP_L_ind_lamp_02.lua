...
---@class ABP_L_ind_lamp_02_C : ABP_Light_Param_C
...
local ABP_L_ind_lamp_02_C = {}

function ABP_L_ind_lamp_02_C:PlayOnSound() end
function ABP_L_ind_lamp_02_C:PlayOffSound() end
function ABP_L_ind_lamp_02_C:UserConstructionScript() end
