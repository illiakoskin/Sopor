...
local EAttenuationDistanceModel = {
    ...
    Custom = 5,
    CustomAbsolute = 6,
    EAttenuationDistanceModel_MAX = 7,
}
...
---@enum EClothSimulationState
local EClothSimulationState = {
    Default = 0,
    DeadBody = 1,
    Lying = 2,
    EClothSimulationState_MAX = 3,
}
...
local EDynamicIfReturnType = {
    RETURNTYPE_Float4 = 0,
    RETURNTYPE_Float3 = 1,
    RETURNTYPE_Float2 = 2,
    RETURNTYPE_Float1 = 3,
    RETURNTYPE_LWCVector4 = 4,
    RETURNTYPE_LWCVector3 = 5,
    RETURNTYPE_LWCVector2 = 6,
    RETURNTYPE_LWCScalar = 7,
    RETURNTYPE_Bool = 8,
    RETURNTYPE_Max = 9,
}
...
---@enum EExternalPoseUse
local EExternalPoseUse = {
    Write = 0,
    Read = 1,
    EExternalPoseUse_MAX = 2,
}
...
local EMaterialPositionTransformSource = {
    ...
    TRANSFORMPOSSOURCE_ActorParent = 7,
...
---@enum ESceneCaptureCachedShadowsLightTypes
local ESceneCaptureCachedShadowsLightTypes = {
    None = 0,
    Directional = 1,
    Local = 14,
    Both = 15,
    ESceneCaptureCachedShadowsLightTypes_MAX = 16,
}
...
local ESceneTextureId = {
    ...
    PPI_WorldTangent = 29,
    PPI_Anisotropy = 30,
    PPI_PostProcessInput7 = 50,
    PPI_PostProcessInput8 = 51,
    PPI_PostProcessInput9 = 52,
    PPI_MAX = 53,
}
...
local TextureGroup = {
    ...
    TEXTUREGROUP_GSC_Asset_D = 52,
    TEXTUREGROUP_GSC_Asset_N = 53,
    TEXTUREGROUP_GSC_Asset_Masks = 54,
    TEXTUREGROUP_GSC_Asset_Alpha = 55,
    TEXTUREGROUP_GSC_Asset_Text = 56,
    TEXTUREGROUP_GSC_Asset_SSS = 57,
    TEXTUREGROUP_GSC_Asset_ID = 58,
    TEXTUREGROUP_GSC_Tileable_D = 59,
    TEXTUREGROUP_GSC_Tileable_N = 60,
    TEXTUREGROUP_GSC_Tileable_Masks = 61,
    TEXTUREGROUP_GSC_Character_D = 62,
    TEXTUREGROUP_GSC_Character_N = 63,
    TEXTUREGROUP_GSC_Character_Masks = 64,
    TEXTUREGROUP_GSC_Character_ID = 65,
    TEXTUREGROUP_GSC_Character_MorphID = 66,
    TEXTUREGROUP_GSC_Character_Alpha = 67,
    TEXTUREGROUP_GSC_Character_Eyes = 68,
    TEXTUREGROUP_GSC_Character_Teeth = 69,
    TEXTUREGROUP_GSC_Character_HairSimple = 70,
    TEXTUREGROUP_GSC_Character_SSS = 71,
    TEXTUREGROUP_GSC_Character_VFX = 72,
    TEXTUREGROUP_GSC_Weapon_D = 73,
    TEXTUREGROUP_GSC_Weapon_N = 74,
    TEXTUREGROUP_GSC_Weapon_Masks = 75,
    TEXTUREGROUP_GSC_Item_D = 76,
    TEXTUREGROUP_GSC_Item_N = 77,
    TEXTUREGROUP_GSC_Item_Masks = 78,
    TEXTUREGROUP_GSC_VFX_SubUV_256 = 79,
    TEXTUREGROUP_GSC_VFX_SubUV_512 = 80,
    TEXTUREGROUP_GSC_VFX_Mesh = 81,
    TEXTUREGROUP_GSC_VFX_Big = 82,
    TEXTUREGROUP_GSC_VFX_Small = 83,
    TEXTUREGROUP_GSC_VFX_Tiny = 84,
    TEXTUREGROUP_GSC_DecalsBig_D = 85,
    TEXTUREGROUP_GSC_DecalsBig_N = 86,
    TEXTUREGROUP_GSC_DecalsBig_Masks = 87,
    TEXTUREGROUP_GSC_DecalsBig_Alpha = 88,
    TEXTUREGROUP_GSC_DecalsSmall_D = 89,
    TEXTUREGROUP_GSC_DecalsSmall_N = 90,
    TEXTUREGROUP_GSC_DecalsSmall_Masks = 91,
    TEXTUREGROUP_GSC_DecalsSmall_Alpha = 92,
    TEXTUREGROUP_GSC_Terrain_D = 93,
    TEXTUREGROUP_GSC_Terrain_N = 94,
    TEXTUREGROUP_GSC_Terrain_Masks = 95,
    TEXTUREGROUP_GSC_Terrain_DP = 96,
    TEXTUREGROUP_GSC_Foliage_D = 97,
    TEXTUREGROUP_GSC_Foliage_N = 98,
    TEXTUREGROUP_GSC_Foliage_Masks = 99,
    TEXTUREGROUP_GSC_Foliage_Alpha = 100,
    TEXTUREGROUP_GSC_Foliage_SSS = 101,
    TEXTUREGROUP_GSC_NoScale_Common = 102,
    TEXTUREGROUP_GSC_NoScale_XVector = 103,
    TEXTUREGROUP_GSC_NoScale_PivotPos = 104,
    TEXTUREGROUP_GSC_Trunk_DP = 105,
    TEXTUREGROUP_GSC_Trunk_N = 106,
    TEXTUREGROUP_GSC_Trunk_D = 107,
    TEXTUREGROUP_GSC_Billboard_D = 108,
    TEXTUREGROUP_GSC_Billboard_N = 109,
    TEXTUREGROUP_GSC_LevelBitmap = 110,
    TEXTUREGROUP_MAX = 111,
}
