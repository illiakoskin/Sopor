...
---@param InAssetData TArray<FAssetData>
---@param OutAssetData TArray<FAssetData>
function UAssetRegistryHelpers:SortAssetData(InAssetData, OutAssetData) end
...
---@param InAssetData FAssetData
---@return FString
function UAssetRegistryHelpers:GetShortName(InAssetData) end
---@param InAssetData FAssetData
---@return FString
