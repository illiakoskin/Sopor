...
---@field bShouldBeAlwaysIgnored boolean
...
---@field bForceRebuildWithFlush boolean
...
---@class ITriggerProgress : IInterface
local ITriggerProgress = {}
...
function UInputMappingContext:SetIgnoreAlwaysForAction(Action, bIgnore) end
---@param Action UInputAction
---@param ToKey FKey
...
---@class UInputTriggerHoldMaxTime : UInputTriggerTimedBase
---@field MaxHoldTimeThreshold float
local UInputTriggerHoldMaxTime = {}



---@class UInputTriggerHoldWithActivationDelay : UInputTriggerTimedBase
---@field HoldTimeThreshold float
---@field HoldActivationThreshold float
local UInputTriggerHoldWithActivationDelay = {}
