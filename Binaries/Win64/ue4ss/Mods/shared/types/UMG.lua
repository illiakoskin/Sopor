...
---@class FTextureRow : FTableRowBase
...
---@param InBarFillType EProgressBarFillType::Type
function UProgressBar:SetBarFillType(InBarFillType) end
...
---@param bIgnorePause boolean
function UUserWidget:ListenForInputAction(ActionName, EventType, bConsume, Callback, bIgnorePause) end
---@return boolean
