---@enum EChromaSDKCoreDeviceTypeEnum
local EChromaSDKCoreDeviceTypeEnum = {
...
local EChromaSDKDeviceTypeEnum = {
    DE_1D = 0,
    DE_2D = 1,
    DE_MAX = 2,
}
...
---@enum EChromaSDKStreamStatusEnum
local EChromaSDKStreamStatusEnum = {
    READY = 0,
    AUTHORIZING = 1,
    BROADCASTING = 2,
    WATCHING = 3,
