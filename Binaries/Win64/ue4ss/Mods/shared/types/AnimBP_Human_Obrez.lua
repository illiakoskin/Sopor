...
---@field __BlendProfile_94 UBlendProfile
---@field __CurveFloat_95 UCurveFloat
---@field __EnumProperty_96 EAlphaBlendOption
---@field __EnumProperty_97 EBlendListTransitionType
---@field __ArrayProperty_98 TArray<float>
...
---@class UAnimBP_Human_Obrez_C : UAnimInstance
...
function UAnimBP_Human_Obrez_C:CharacterWeapon(InPose, IsRelaxed, IsCrouching, IsZombie, IsInDialog, IsMoving, IsAiming, CharacterWeapon) end
---@param AnimGraph FPoseLink
function UAnimBP_Human_Obrez_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function UAnimBP_Human_Obrez_C:ExecuteUbergraph_AnimBP_Human_Obrez(EntryPoint) end
