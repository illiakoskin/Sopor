...
---@field bDrawNavBoundsIntersection boolean
---@field bDrawNavBounds boolean
---@field bDrawDirtyTilesBB boolean
...
---@field MaxAsyncBuildTasksEditor int32
---@field MaxAsyncBuildTasksGameThread int32
...
---@field bGenerateDetailedMesh boolean
...
---@field bGSCEnableStagingValidation boolean
