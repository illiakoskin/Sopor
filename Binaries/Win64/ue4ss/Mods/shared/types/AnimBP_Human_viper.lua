...
---@class UAnimBP_Human_viper_C : UAnimInstance
...
function UAnimBP_Human_viper_C:CharacterWeapon(InPose, IsRelaxed, IsCrouching, IsZombie, IsInDialog, IsMoving, IsAiming, CharacterWeapon) end
---@param AnimGraph FPoseLink
function UAnimBP_Human_viper_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function UAnimBP_Human_viper_C:ExecuteUbergraph_AnimBP_Human_viper(EntryPoint) end
