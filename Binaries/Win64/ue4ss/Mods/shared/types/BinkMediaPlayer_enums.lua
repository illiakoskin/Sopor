...
local EBinkMediaPlayerBinkBufferModes = {
    BMASM_Bink_Stream = 0,
...
local EBinkMediaPlayerBinkDrawStyle = {
...
local EBinkMediaPlayerBinkSoundTrack = {
...
local EBinkMoviePlayerBinkBufferModes = {
    MP_Bink_Stream = 0,
...
local EBinkMoviePlayerBinkSoundTrack = {
